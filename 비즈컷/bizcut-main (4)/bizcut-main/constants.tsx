...
import { Utensils, Shirt, Apple, Coffee, Scissors, ShoppingBag, Heart, Hammer, Edit3, MapPin, Camera, Zap, Sun, Box, Moon, History, Star, Leaf, User, Gem, Flame, Crown, Feather, Film, Palette, Circle, Aperture, BookOpen, Sunset, Sparkles } from 'lucide-react';
...
export const UI_MESSAGES = {
  STEP_1_TITLE: "어떤 가게를 하시나요?",
  STEP_1_SUB: "사장님 업종을 선택해주세요.",
  STEP_2_TITLE: "사진을 넣어주세요 (최대 4장)",
  STEP_2_SUB: "번호를 누르거나 Ctrl+V로 붙여넣으세요.",
  STEP_3_TITLE: "작업 진행 중...",
  STEP_3_SUB: "AI가 사장님의 사진을 명품으로 바꾸고 있습니다.",
  BTN_PROCESS_ALL: "4장 한꺼번에 보정하기",
  BTN_SAVE_ALL: "전체 저장하기",
  SPECIAL_LABEL: "특별 요청 사항",
  SPECIAL_PLACEHOLDER: "예: 배경을 더 환하게, 반짝거리는 효과 추가..."
};

// ─── 🧔 남성 포트레이트 스타일 (사장님컷) ───────────────────────
export const PORTRAIT_STYLES_MALE: PhotoStyle[] = [
  {
    id: 'pm_id_photo',
    name: '증명사진 / 여권사진',
    icon: <User size={28} />,
...
// ─── 👩 여성 포트레이트 스타일 (사장님컷) ───────────────────────
export const PORTRAIT_STYLES_FEMALE: PhotoStyle[] = [
  {
    id: 'pf_id_photo',
    name: '증명사진 / 여권사진',
    icon: <User size={28} />,
...
// ─── 💈 남성 헤어/뷰티 스타일 ───────────────────────────────────
export const BEAUTY_STYLES_MALE: PhotoStyle[] = [
  {
    id: 'bm_buzz',
    name: '클린 버즈컷',
...
// ─── 💇 여성 헤어/뷰티 스타일 ───────────────────────────────────
export const BEAUTY_STYLES_FEMALE: PhotoStyle[] = [
  {
    id: 'bf_pixie',
    name: '픽시컷',
    icon: <Scissors size={28} />,
