      ...
      <div className="bg-white w-full max-w-7xl h-[90vh] rounded-[3rem] shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-500 border border-white/20">
        ...
        <div className="px-10 py-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-orange-600 rounded-3xl flex items-center justify-center text-white shadow-lg shadow-orange-200">
              <Search size={28} />
            </div>
            <div>
          ...
          <div className="flex-1 flex flex-col bg-slate-50/30 overflow-hidden">
            ...
            <div className="p-6 md:p-8 space-y-6">
              <div className="relative group">
                <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-orange-600 transition-colors" size={24} />
                <input 
                  type="text"
                  placeholder="원하는 분위기나 키워드를 입력하세요... (예: 90s retro, cinematic, urban street)"
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-16 pr-6 py-5 bg-white border border-slate-200 rounded-[2rem] text-lg font-bold shadow-sm focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100 transition-all placeholder:text-slate-300"
                />
              </div>

              {searchTerm && (
                <div className="flex items-center gap-2 text-sm font-bold text-orange-600 animate-in fade-in slide-in-from-left-4">
                    ...
                    >
                      ...
                      <div className="p-6 flex-1 flex flex-col gap-3">
                        <div className="flex flex-col gap-1">
                          <h4 className="font-black text-slate-800 text-base leading-tight group-hover:text-orange-600 transition-colors">
                        ...
                        <div className="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                          <button 
                            ...
                            className="flex-1 py-3 bg-slate-900 text-white rounded-xl text-xs font-black shadow-lg hover:bg-orange-600 active:scale-95 transition-all flex items-center justify-center gap-2"
                          >
